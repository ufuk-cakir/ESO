...
class AnnotationReader:
    ...
    def dataframe_to_svl(self, dataframe, sample_rate, start_m, end_m):
        ...
        with tag("sv"):
            with tag("data"):
                model_string = '<model id="10" name="" sampleRate="{}" start="{}" end="{}" type="sparse" dimensions="2" resolution="1" notifyOnAdd="true" dataset="9" subtype="box" minimum="600" maximum="{}" units="Hz" />'.format(
                    sample_rate, start_m, end_m, 1000
                )
